...
Dispatches a `wheel` event. This method is usually used to manually scroll the page. See [scrolling](../../Guides/Actions/input.md#scrolling) for alternative ways to scroll.
