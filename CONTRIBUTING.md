...
* Playwright repository
  * == MULTI-package repository /
    ...
    * if you want to check
      * browser APIs -> [`packages/playwright-core`](packages/playwright-core)
      * test runner -> [`packages/playwright`](packages/playwright)

* some files are generated -- by -- the [build script](package.json)
  * [MORE](.claude/skills/playwright-dev/api.md)
  * _Example:_ TypeScript types for the API are generated -- from -- the ["docs/src"](docs/src)
...
Coding style is fully defined in [eslint.config.mjs](https://github.com/microsoft/playwright/blob/main/eslint.config.mjs)
* Before creating a pull request, or at any moment during development, run linter to check all kinds of things:
  ```bash
  npm run lint
  ```

Comments should have an explicit purpose and should improve readability rather than hinder it
* If the code would not be understood without comments, consider re-writing the code to make it self-explanatory.
